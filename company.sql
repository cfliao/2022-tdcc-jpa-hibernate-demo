...
--
-- Temporary table structure for view `avgsal`
--

DROP TABLE IF EXISTS `avgsal`;
/*!50001 DROP VIEW IF EXISTS `avgsal`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `avgsal` (
  `dno` int(4),
  `AVGSAL` decimal(14,6)
) ENGINE=MyISAM */;
...
--
-- Final view structure for view `avgsal`
--

/*!50001 DROP TABLE IF EXISTS `avgsal`*/;
/*!50001 DROP VIEW IF EXISTS `avgsal`*/;
...
/*!50001 VIEW `avgsal` AS select `employee`.`dno` AS `dno`,avg(`employee`.`salary`) AS `AVGSAL` from (`department` join `employee`) where (`employee`.`dno` = `department`.`dnumber`) group by `employee`.`dno` */;
...
-- Dump completed on 2012-11-20 13:59:14
